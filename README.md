...
|---|---|---|
| Fachry Aurellino P. | Project Initiator | Membuat repository, mengatur akses kolaborator, commit `index.html` |
| Kevin Ceshario B. | Styling Engineer | Membuat branch `styling`, menambahkan & menghubungkan `style.css` |
| Albertus Kevin T. | Script Engineer | Membuat branch `scripting`, menambahkan & menghubungkan `script.js` |
